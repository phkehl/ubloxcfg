...
"    Notes:\n"
"\n"
"        All hardware resets will cause a USB disconnect and the host will\n"
"        re-enumerate the device. For local serial <port>s (ser://<device>)\n"
"        this will be taken into account and should be handled by this command.\n"
"\n"
