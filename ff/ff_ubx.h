...
#define UBX_NAV_SBAS_MSGID           0x32
#define UBX_NAV_SIG_MSGID            0x43
#define UBX_NAV_SLAS_MSGID           0x42
...
#define UBX_NAV_TIMELS_MSGID         0x26
#define UBX_NAV_TIMEQZSS_MSGID       0x27
#define UBX_NAV_TIMENAVIC_MSGID      0x63
#define UBX_NAV_TIMEUTC_MSGID        0x21
#define UBX_NAV_TIMETRUSTED_MSGID    0x64
#define UBX_NAV_VELECEF_MSGID        0x11
#define UBX_NAV_VELNED_MSGID         0x12

#define UBX_NAV2_CLSID               0x29
#define UBX_NAV2_CLOCK_MSGID         UBX_NAV_CLOCK_MSGID
#define UBX_NAV2_COV_MSGID           UBX_NAV_COV_MSGID
#define UBX_NAV2_DOP_MSGID           UBX_NAV_DOP_MSGID
#define UBX_NAV2_EOE_MSGID           UBX_NAV_EOE_MSGID
#define UBX_NAV2_ODO_MSGID           UBX_NAV_ODO_MSGID
#define UBX_NAV2_POSECEF_MSGID       UBX_NAV_POSECEF_MSGID
#define UBX_NAV2_POSLLH_MSGID        UBX_NAV_POSLLH_MSGID
#define UBX_NAV2_PVT_MSGID           UBX_NAV_PVT_MSGID
#define UBX_NAV2_SAT_MSGID           UBX_NAV_SAT_MSGID
#define UBX_NAV2_SBAS_MSGID          UBX_NAV_SBAS_MSGID
#define UBX_NAV2_SIG_MSGID           UBX_NAV_SIG_MSGID
#define UBX_NAV2_SLAS_MSGID          UBX_NAV_SLAS_MSGID
#define UBX_NAV2_STATUS_MSGID        UBX_NAV_STATUS_MSGID
#define UBX_NAV2_SVIN_MSGID          UBX_NAV_SVIN_MSGID
#define UBX_NAV2_TIMEBDS_MSGID       UBX_NAV_TIMEBDS_MSGID
#define UBX_NAV2_TIMEGAL_MSGID       UBX_NAV_TIMEGAL_MSGID
#define UBX_NAV2_TIMEGLO_MSGID       UBX_NAV_TIMEGLO_MSGID
#define UBX_NAV2_TIMEGPS_MSGID       UBX_NAV_TIMEGPS_MSGID
#define UBX_NAV2_TIMELS_MSGID        UBX_NAV_TIMELS_MSGID
#define UBX_NAV2_TIMEQZSS_MSGID      UBX_NAV_TIMEQZSS_MSGID
#define UBX_NAV2_TIMENAVIC_MSGID     UBX_NAV_TIMENAVIC_MSGID
#define UBX_NAV2_TIMEUTC_MSGID       UBX_NAV_TIMEUTC_MSGID
#define UBX_NAV2_VELECEF_MSGID       UBX_NAV_VELECEF_MSGID
#define UBX_NAV2_VELNED_MSGID        UBX_NAV_VELNED_MSGID
...
#define UBX_RXM_COR_MSGID            0x14
#define UBX_RXM_PMP_MSGID            0x72
...
#define UBX_SEC_OSNMA_MSGID          0x0a
#define UBX_SEC_SIG_MSGID            0x09
#define UBX_SEC_SIGLOG_MSGID         0x10
...
#define UBX_MESSAGES(_P_) \
    ...
    _P_(UBX_MON_CLSID,  UBX_MON_SYS_MSGID,         "UBX-MON-SYS") \
    ...
    _P_(UBX_NAV_CLSID,  UBX_NAV_PL_MSGID,          "UBX-NAV-PL") \
    ...
    _P_(UBX_NAV_CLSID,  UBX_NAV_TIMEQZSS_MSGID,    "UBX-NAV-TIMEQZSS") \
    _P_(UBX_NAV_CLSID,  UBX_NAV_TIMENAVIC_MSGID,   "UBX-NAV-TIMENAVIC") \
    _P_(UBX_NAV_CLSID,  UBX_NAV_TIMEUTC_MSGID,     "UBX-NAV-TIMEUTC") \
    _P_(UBX_NAV_CLSID,  UBX_NAV_TIMETRUSTED_MSGID, "UBX-NAV-TIMETRUSTED") \
    _P_(UBX_NAV_CLSID,  UBX_NAV_VELECEF_MSGID,     "UBX-NAV-VELECEF") \
    _P_(UBX_NAV_CLSID,  UBX_NAV_VELNED_MSGID,      "UBX-NAV-VELNED") \
    _P_(UBX_NAV2_CLSID, UBX_NAV2_CLOCK_MSGID,      "UBX-NAV2-CLOCK") \
    _P_(UBX_NAV2_CLSID, UBX_NAV2_COV_MSGID,        "UBX-NAV2-COV") \
    _P_(UBX_NAV2_CLSID, UBX_NAV2_DOP_MSGID,        "UBX-NAV2-DOP") \
    _P_(UBX_NAV2_CLSID, UBX_NAV2_EOE_MSGID,        "UBX-NAV2-EOE") \
    _P_(UBX_NAV2_CLSID, UBX_NAV2_ODO_MSGID,        "UBX-NAV2-ODO") \
    _P_(UBX_NAV2_CLSID, UBX_NAV2_POSECEF_MSGID,    "UBX-NAV2-POSECEF") \
    _P_(UBX_NAV2_CLSID, UBX_NAV2_POSLLH_MSGID,     "UBX-NAV2-POSLLH") \
    _P_(UBX_NAV2_CLSID, UBX_NAV2_PVT_MSGID,        "UBX-NAV2-PVT") \
    _P_(UBX_NAV2_CLSID, UBX_NAV2_SAT_MSGID,        "UBX-NAV2-SAT") \
    _P_(UBX_NAV2_CLSID, UBX_NAV2_SBAS_MSGID,       "UBX-NAV2-SBAS") \
    _P_(UBX_NAV2_CLSID, UBX_NAV2_SIG_MSGID,        "UBX-NAV2-SIG") \
    _P_(UBX_NAV2_CLSID, UBX_NAV2_SLAS_MSGID,       "UBX-NAV2-SLAS") \
    _P_(UBX_NAV2_CLSID, UBX_NAV2_STATUS_MSGID,     "UBX-NAV2-STATUS") \
    _P_(UBX_NAV2_CLSID, UBX_NAV2_SVIN_MSGID,       "UBX-NAV2-SVIN") \
    _P_(UBX_NAV2_CLSID, UBX_NAV2_TIMEBDS_MSGID,    "UBX-NAV2-TIMEBDS") \
    _P_(UBX_NAV2_CLSID, UBX_NAV2_TIMEGAL_MSGID,    "UBX-NAV2-TIMEGAL") \
    _P_(UBX_NAV2_CLSID, UBX_NAV2_TIMEGLO_MSGID,    "UBX-NAV2-TIMEGLO") \
    _P_(UBX_NAV2_CLSID, UBX_NAV2_TIMEGPS_MSGID,    "UBX-NAV2-TIMEGPS") \
    _P_(UBX_NAV2_CLSID, UBX_NAV2_TIMELS_MSGID,     "UBX-NAV2-TIMELS") \
    _P_(UBX_NAV2_CLSID, UBX_NAV2_TIMEQZSS_MSGID,   "UBX-NAV2-TIMEQZSS") \
    _P_(UBX_NAV2_CLSID, UBX_NAV2_TIMENAVIC_MSGID,  "UBX-NAV2-TIMENAVIC") \
    _P_(UBX_NAV2_CLSID, UBX_NAV2_TIMEUTC_MSGID,    "UBX-NAV2-TIMEUTC") \
    _P_(UBX_NAV2_CLSID, UBX_NAV2_VELECEF_MSGID,    "UBX-NAV2-VELECEF") \
    _P_(UBX_NAV2_CLSID, UBX_NAV2_VELNED_MSGID,     "UBX-NAV2-VELNED") \
    ...
    _P_(UBX_RXM_CLSID,  UBX_RXM_COR_MSGID,         "UBX-RXM-COR") \
    ...
    _P_(UBX_SEC_CLSID,  UBX_SEC_OSNMA_MSGID,       "UBX-SEC-OSNMA") \
    _P_(UBX_SEC_CLSID,  UBX_SEC_SIG_MSGID,         "UBX-SEC-SIG") \
    _P_(UBX_SEC_CLSID,  UBX_SEC_SIGLOG_MSGID,      "UBX-SEC-SIGLOG") \
...
#define UBX_SIGID_GPS_L5I   6
#define UBX_SIGID_GPS_L5Q   7
#define UBX_SIGID_SBAS_L1CA 0
#define UBX_SIGID_GAL_E1C   0
#define UBX_SIGID_GAL_E1B   1
#define UBX_SIGID_GAL_E5AI  3
#define UBX_SIGID_GAL_E5AQ  4
#define UBX_SIGID_GAL_E5BI  5
#define UBX_SIGID_GAL_E5BQ  6
#define UBX_SIGID_GAL_E6B   8
#define UBX_SIGID_GAL_E6C   9
#define UBX_SIGID_GAL_E6A  10
#define UBX_SIGID_BDS_B1ID1 0
#define UBX_SIGID_BDS_B1ID2 1
#define UBX_SIGID_BDS_B2ID1 2
#define UBX_SIGID_BDS_B2ID2 3
#define UBX_SIGID_BDS_B3ID1 4
#define UBX_SIGID_BDS_B3ID2 10
#define UBX_SIGID_BDS_B1CP  5
#define UBX_SIGID_BDS_B1CD  6
#define UBX_SIGID_BDS_B2AP  7
#define UBX_SIGID_BDS_B2AD  8
#define UBX_SIGID_QZSS_L1CA 0
#define UBX_SIGID_QZSS_L1S  1
#define UBX_SIGID_QZSS_L2CM 4
#define UBX_SIGID_QZSS_L2CL 5
#define UBX_SIGID_QZSS_L5I  8
#define UBX_SIGID_QZSS_L5Q  9
#define UBX_SIGID_GLO_L1OF  0
#define UBX_SIGID_GLO_L2OF  2
#define UBX_SIGID_NAVIC_L5A 0
...
#define UBX_TIM_TP_V0_FLAGS_TPNOTLOCKED                              0x20
#define UBX_TIM_TP_V0_REFINFO_TIMEREFGNSS_GET(f)                     ( (uint8_t)(f) & 0x0f )
#define UBX_TIM_TP_V0_REFINFO_TIMEREFGNSS_GPS                        0
#define UBX_TIM_TP_V0_REFINFO_TIMEREFGNSS_GLO                        1
#define UBX_TIM_TP_V0_REFINFO_TIMEREFGNSS_BDS                        2
#define UBX_TIM_TP_V0_REFINFO_TIMEREFGNSS_GAL                        3
#define UBX_TIM_TP_V0_REFINFO_TIMEREFGNSS_NAVIC                      4
#define UBX_TIM_TP_V0_REFINFO_TIMEREFGNSS_UNKNOWN                    15
#define UBX_TIM_TP_V0_REFINFO_UTCSTANDARD_GET(f)                     ( ((uint8_t)(f) >> 4) & 0x0f )
#define UBX_TIM_TP_V0_REFINFO_UTCSTANDARD_INFONA                     0
#define UBX_TIM_TP_V0_REFINFO_UTCSTANDARD_CRL                        1
#define UBX_TIM_TP_V0_REFINFO_UTCSTANDARD_NIST                       2
#define UBX_TIM_TP_V0_REFINFO_UTCSTANDARD_USNO                       3
#define UBX_TIM_TP_V0_REFINFO_UTCSTANDARD_BIPM                       4
#define UBX_TIM_TP_V0_REFINFO_UTCSTANDARD_EU                         5
#define UBX_TIM_TP_V0_REFINFO_UTCSTANDARD_SU                         6
#define UBX_TIM_TP_V0_REFINFO_UTCSTANDARD_NTSC                       7
#define UBX_TIM_TP_V0_REFINFO_UTCSTANDARD_NPLI                       8
#define UBX_TIM_TP_V0_REFINFO_UTCSTANDARD_UNNOWN                     15
