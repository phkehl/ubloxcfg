// ubloxcfg -- u-blox positioning receivers configuration library test program
//
...
int main(int argc, char **argv)
{
    ...
    // Analyse results
    printf("%d tests: %d passed, %d failed -- %s\n", numTests, numPass, numFail, ubloxcfg_getVersionStr());
    if (numFail != 0)
    {
